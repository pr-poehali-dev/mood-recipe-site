      ...
      <footer className="py-12 bg-gradient-to-r from-gray-900 to-gray-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <p className="text-gray-400">
            © 2025 sirius55. Создано с любовью ❤️
          </p>
        </div>
      </footer>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-[#FFD93D]/10 to-[#FFD93D]/5 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm italic">
                    Научный факт: даже искусственная улыбка активирует те же участки мозга, что и настоящая, улучшая настроение на физиологическом уровне. Улыбка снижает уровень кортизола (гормона стресса) и повышает серотонин.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-[#FF6B9D]/10 to-[#FF6B9D]/5 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm italic">
                    Идеи для "своего времени": утренняя йога или растяжка, журналинг (ведение дневника благодарности), рисование или раскрашивание, прослушивание любимой музыки или подкастов, наблюдение за природой из окна, ароматерапия с эфирными маслами.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-[#4ECDC4]/10 to-[#4ECDC4]/5 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm italic">
                    Создайте позитивное окружение: украсьте рабочее место фотографиями приятных моментов, создайте плейлист из любимых песен для разного настроения, подпишитесь на аккаунты с вдохновляющим контентом, окружите себя любимыми ароматами (свечи, духи), добавьте живые растения в интерьер.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-[#FFD93D]/10 to-[#FF6B9D]/10 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm italic">
                    Методы практики благодарности: ведение дневника благодарности перед сном, выражение признательности близким вслух или в сообщениях, медитация благодарности (5 минут тихой благодарности), создание "банки благодарности" с записками о хорошем, фотоальбом приятных моментов.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-[#4ECDC4]/10 to-[#FFD93D]/10 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm italic">
                    Простые добрые дела на каждый день: искренне похвалите коллегу, придержите дверь для незнакомца, поделитесь полезной информацией, помогите соседу с покупками, напишите благодарность человеку, который изменил вашу жизнь, покормите бездомное животное, уступите место в транспорте.
                  </p>
                </div>
              </div>

              <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-[#FF6B9D]/10 to-[#4ECDC4]/10 rounded-xl">
                <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-[#FF6B9D] to-[#4ECDC4] rounded-full flex items-center justify-center text-white font-bold">
                  6
                </div>
                <div>
                  <h3 className="font-bold text-lg mb-2">Двигайтесь и дышите</h3>
                  <p className="text-gray-600 mb-2">
                    Физическая активность и правильное дыхание — мощные инструменты для улучшения настроения и энергии.
                  </p>
                  <p className="text-gray-500 text-sm italic">
                    Варианты движения: 15-минутная прогулка на свежем воздухе, танцы под любимую музыку, простые упражнения или растяжка. Дыхательные практики: техника 4-7-8 (вдох 4 сек, задержка 7 сек, выдох 8 сек), диафрагмальное дыхание, дыхание "квадрат" (4 сек вдох-задержка-выдох-задержка).
                  </p>
                </div>
              </div>

              <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-[#FFD93D]/10 to-[#4ECDC4]/10 rounded-xl">
                <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-[#FFD93D] to-[#FF6B9D] rounded-full flex items-center justify-center text-white font-bold">
                  7
                </div>
                <div>
                  <h3 className="font-bold text-lg mb-2">Ограничьте негатив</h3>
                  <p className="text-gray-600 mb-2">
                    Осознанно управляйте потоком информации и защищайте свое ментальное пространство от токсичности.
                  </p>
                  <p className="text-gray-500 text-sm italic">
                    Как сократить негатив: ограничьте просмотр новостей до 15 минут в день, отпишитесь от аккаунтов, вызывающих стресс или зависть, установите границы в токсичных отношениях, практикуйте цифровой детокс (1-2 часа без гаджетов), замените критику себя на конструктивный диалог.
                  </p>
                </div>
              </div>

              <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-[#4ECDC4]/10 to-[#FF6B9D]/10 rounded-xl">
                <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-[#4ECDC4] to-[#FFD93D] rounded-full flex items-center justify-center text-white font-bold">
                  8
                </div>
                <div>
                  <h3 className="font-bold text-lg mb-2">Высыпайтесь и питайтесь осознанно</h3>
                  <p className="text-gray-600 mb-2">
                    Качественный сон и правильное питание — фундамент хорошего настроения и энергии на весь день.
                  </p>
                  <p className="text-gray-500 text-sm italic">
                    Советы для сна: ложитесь и вставайте в одно время, создайте ритуал перед сном (чтение, легкая растяжка), избегайте экранов за час до сна, проветривайте спальню. Для питания: пейте достаточно воды, включите в рацион "продукты счастья" (бананы, орехи, темный шоколад, авокадо), ешьте осознанно без спешки.
                  </p>
                </div>
              </div>
            </div>
